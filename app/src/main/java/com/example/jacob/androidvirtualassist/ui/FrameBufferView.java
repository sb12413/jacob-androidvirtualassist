...
package com.example.jacob.androidvirtualassist.ui;
...
import com.example.jacob.androidvirtualassist.ViewerThread;
 ...
 *
 * It receives framebuffer update notifications from the VNC SDK in the ViewerThread, and so any
